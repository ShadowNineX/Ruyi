...
export const MAX_AGENT_IMAGE_INPUTS = 4;
...
export const AGENT_SESSION_ITEM_CAP = 60;
export const AGENT_SESSION_SEED_MESSAGE_LIMIT = 24;
export const AGENT_SESSION_COMPACTION_TRIGGER_ITEMS = 52;
export const AGENT_SESSION_RECENT_ITEM_KEEP = 28;
export const AGENT_SESSION_COMPACTION_ITEM_MAX_LEN = 1200;
export const AGENT_SESSION_SUMMARY_MAX_LEN = 2500;
export const AGENT_SESSION_COMPACTION_TIMEOUT_MS = 60 * 1000;
export const CHANNEL_SUMMARY_CONTEXT_MAX_LEN = 1800;

export const USER_MEMORY_CAP = 100;
export const MEMORY_VALUE_MAX_LEN = 500;

// Auto-extraction (c.ai-style long-term memory)
export const AUTO_EXTRACT_THRESHOLD = 24; // user messages per (channel, user) before extraction
export const AUTO_EXTRACT_COOLDOWN_MS = 60 * 60 * 1000; // min time between extractions per user
export const AUTO_EXTRACT_HISTORY_WINDOW = 18; // recent messages fed to extractor
