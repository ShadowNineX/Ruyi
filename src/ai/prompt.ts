...
- Decide in this order:
  ...
  3. Time/date and reminders: use resolve_time for named places, calendar-like relative dates, dayparts, and clock phrases. For countdown timers like "in 20 minutes", calculate due_unix from the CURRENT TIME Unix value, using calculator when needed, then call manage_reminder with the exact due_unix.
