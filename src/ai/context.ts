  ...
  async buildDynamicContext(
    ...
    const assistantStyleBoundary
      = options.personality === 'tails'
        ? 'Current character voice: Tails. Reply like a clever young mechanic friend, not an assistant. Keep Steam comments short and natural; ASCII emoticons like :D are okay; no actual Unicode emoji, no formal lord/master/servant address from Ruyi.'
